...
const Footer = () => {
  return (
    <footer className=" pt-12 md:pt-20 bg-gray-900 mt-12 md:mt-20">
      <div className="container gap-8 flex-col md:flex-row flex justify-between">
        <div>
        ...
        <div className="space-y-3">
          ...
          <div>
            <h2 className=" mb-3 text-2xl text-white">Newsletter</h2>
      ...
      <div className="sm:flex container  sm:items-center pb-5 sm:justify-between">
